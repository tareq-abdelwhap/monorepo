...
const data = computed(() => {
  return history.value.incomes?.reduce((acc: any, curr) => {
  ...
  datasets: [
    {
      ...
      backgroundColor: '#22c55e30', // Area color soft Green
      borderColor: '#22c55e', // Line color Green
      tension: 0.4,
    },
  ],
}));
...
<template>
  <BaseCard>
    <span
      class="text-lg font-semibold ms-5 my-3 text-green-600"
