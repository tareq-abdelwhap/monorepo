...
<template>
  <footer class="mt-auto">
    <div
      :class="[
        'border-t-2 border-t-neutral-gray-22',
        'py-20 container',
    ...
    <div class="py-6 container text-nun-sm border-t-2 border-t-neutral-gray-22">
      Dotipad © 2021 • support@dotipad.io • All rights reserved. Designed by
      Twenty-Two
    </div>
  </footer>
</template>
